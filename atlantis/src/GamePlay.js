...
GamePlayManager = {
    ...
    preload: function() {
        ...
        game.load.audio('loop', 'assets/sounds/musicLoop.mp3');
        game.load.audio('pop', 'assets/sounds/sfxPop.mp3');
    },
    create: function() {
        //console.log("create");
        ...
        this.timerGameOver = game.time.events.loop(Phaser.Timer.SECOND, function(){
            ...
            if(this.flagFirstMouseDown){
                ...
                if(this.totalTime<=0){
                    ...
                    this.endGame =true;
                    this.showFinaleMessage("FIN DEL JUEGO");
                }
            }
        }, this);
    ...
    increaseScore: function(){
        ...
        this.amountDiamondsCaugth += 1;
        if(this.amountDiamondsCaugth >= AMOUNT_DIAMONDS){
            game.time.events.remove(this.timerGameOver);
            this.endGame =true;
            this.showFinaleMessage('Felicidades');
        }
    },
    showFinaleMessage: function(msg){
    ...
    */
    update: function() {
        ...
        //console.log("update");
        //this.horse.angle +=1; //con esta instruccion hacemos girar el sprite
            for(var i=0; i<AMOUNT_BOOBLES; i++){
